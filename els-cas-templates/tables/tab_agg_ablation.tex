\begin{table*}[pos=t]
\centering
\caption{Aggregation-sensitivity ablation: clean image AUROC averaged over representative classes and seeds from 0 to 2 for max and top-$\rho$ mean pooling. Bold marks the best aggregator in each row.}
