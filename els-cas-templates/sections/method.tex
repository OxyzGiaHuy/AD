...
Beyond producing a calibrated alarm score, the reliability framework records entropy, expert disagreement, conformal confidence, and effective sample size as selective-risk signals. These quantities are not used to change the anomaly ranking. Instead, they support deployment diagnostics such as abstention, risk-coverage analysis, and manual review of low-confidence alarms.
